...
#
# save_as_json(
# results_empty, os.path.join(CFG['result_dir'], 'results_insample_empty.json')
# )
# exit()
...
#
# print('---> Training on wildlife data')
# # TODO think about necessity of val data here (tuning trainer is also trained on both)
...
#
# save_as_json(
#     results_tuning, os.path.join(CFG['result_dir'], 'results_insample_tuning.json')
# )
# exit()
...
#
# save_as_json(
#     results_perf_passive, os.path.join(CFG['result_dir'], 'results_oosample_perf.json')
# )
# exit()
...
for learner, mode in zip(
    ...
    save_as_json(
        results, os.path.join(CFG['result_dir'], f'results_oosample_active_{mode}.json')
    )
